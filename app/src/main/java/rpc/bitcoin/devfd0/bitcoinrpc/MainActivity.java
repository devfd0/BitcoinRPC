...
import rpc.bitcoin.devfd0.bitcoinrpc.cobj.CResultadogetwalletinfo;
...
public class MainActivity extends Activity  implements AsyncResponse {
    ...
    TextView verBalance = null, verVersion = null, verConexions = null,verFecha = null,verServidor = null,txcount = null;
    Button Actualizar = null,detener = null,opciones = null,config=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txcount = (TextView)findViewById(R.id.TextView021);
        ...
        config.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // conectar();
                ...
                intent.setClass(getApplicationContext(),Configuracion.class);
    ...
    void cargarDatos(){
        ...
        txcount.setText(ini.getvalor("txcount", "Sin carga"));
    ...
    void guardarDatos(){
        ...
        ini.setValor("txcount", txcount.getText().toString());
    }
    String getFecha(){
            ...
            if (result.contains("balance")) {
                ...
                if (ii!=null){
                    if (result.contains(("balance")))
                        ...
                        verVersion.setText(ii.getWalletversion().toString());
                        verConexions.setText(ii.getWalletname());
                        verFecha.setText(getFecha());
                        txcount.setText(Integer.toString(ii.getTxcount()));
                        guardarDatos();
                }
                else
                {
