 ...
 */
package rpc.bitcoin.devfd0.bitcoinrpc.barcode;
...
import rpc.bitcoin.devfd0.bitcoinrpc.R;
import rpc.bitcoin.devfd0.bitcoinrpc.camera.CameraSource;
import rpc.bitcoin.devfd0.bitcoinrpc.camera.CameraSourcePreview;
...
public final class BarcodeCaptureActivity extends Activity
    ...
    public void onDetectedQrCode(Barcode barcode) {
        if (barcode != null) {
            ...
            data.putExtra("code", barcode.displayValue.toString());
